const enUS = {
  ...
  models: {
    ...
    streamingAbility: 'Streaming',
    apiKeyNotConfigured: 'Not configured',
    providerDeleteBuiltinBlocked: 'Built-in providers cannot be deleted',
    ...
    otherProtocolAdapters: 'More protocol adapters',
    ...
    requester: 'API Protocol',
    apiMode: 'API Mode',
    selectRequester: 'Select API protocol',
    requesterHint:
      'Choose the API-compatible calling protocol. It does not need to match the real model vendor. For domestic models, use OpenAI protocol except MiniMax, which uses Claude protocol.',
    protocol: {
    ...
    providerNamePlaceholder: 'E.g. Company model gateway',
    providerNameRequired: 'Connection name is required',
    requesterRequired: 'API protocol is required',
    ...
    providerDeleteBlocked:
      'Delete all models under this provider before deleting it',
    deleteProviderConfirmation:
      'Are you sure you want to delete this provider?',
    loadError: 'Failed to load data',
    chat: 'Chat',
    embedding: 'Embedding',
    textCategory: 'Text Models',
    embeddingCategory: 'Embedding Models',
    voiceCategory: 'Speech Synthesis',
    asrCategory: 'Speech Recognition',
    pdfCategory: 'PDF Parsing',
    textConfigTitle: 'Text model settings',
    embeddingConfigTitle: 'Embedding model settings',
    voiceConfigTitle: 'Speech synthesis settings',
    asrConfigTitle: 'Speech recognition settings',
    pdfConfigTitle: 'PDF parsing settings',
    textListTitle: 'Text models',
    embeddingListTitle: 'Embedding models',
    voiceListTitle: 'Voice models',
    asrListTitle: 'Speech recognition models',
    pdfListTitle: 'PDF parsing models',
    textListHint: 'Models used for chat and vision understanding.',
    embeddingListHint:
      'Used for knowledge base vector search. Set the model field in extra args, e.g. text-embedding-v3.',
    voiceListHint: 'Models with text-to-speech ability enabled.',
    asrListHint: 'Models with speech recognition ability enabled.',
    pdfListHint: 'Models with PDF parsing ability enabled.',
    noEmbeddingModels: 'No embedding models yet. Click Add Model.',
    noVoiceModels: 'No voice models yet. Add a model and enable TTS.',
    noAsrModels: 'No ASR models yet. Add a model and enable speech recognition.',
    noPdfModels: 'No PDF parsing models yet. Add a model and enable PDF parsing.',
    asrAbility: 'Speech Recognition',
    asrTestTitle: 'Test ASR',
    asrTestPlaceholder: 'Recognition result will appear after recording',
    asrTestStart: 'Start Recording',
    asrTestStop: 'Stop Recording',
    asrRecordRequired: 'Please record audio before testing',
    asrMicUnavailable: 'Microphone access is unavailable. Check browser permissions.',
    asrRecordError: 'Failed to process the recording. Please try again.',
    pdfParseAbility: 'PDF Parsing',
    rerank: 'Rerank',
    rerankUrlTooltip:
  ...
  plugins: {
    ...
    fileUpload: {
      tooLarge: 'File size exceeds 500MB limit',
  ...
  pipelines: {
    ...
    templateConfig: {
      asrModelSectionTitle: 'Speech Recognition Model',
      asrModelSectionDescription:
        'Choose the ASR model used when users send voice messages.',
      asrModelLabel: 'Speech recognition model',
      asrModelPlaceholder: 'Select a speech recognition model',
      asrModelEmptyHint: 'Add a speech recognition model in Model Settings first',
      asrFallbackLabel: 'Fallback text when recognition fails',
      asrFallbackPlaceholder:
        'The user sent a voice message. Please reply in short sentences.',
    },
    extensions: {
      title: 'Extensions',
  ...
  productLibrary: {
    description: 'Manage products and course materials for digital employees',
    pageTitle: 'Product Library',
    pageDescription:
      'Maintain products under product lines. One line (for example Yuanfudao) can contain multiple products that digital employees reference in replies.',
    searchPlaceholder: 'Search by name, category, or selling points',
    createProduct: 'Add product',
    createDialogDescription:
      'Fill in basic info and sales materials. Agents and workflows can reference them after saving.',
    emptyListTitle: 'No products yet',
    emptyListDescription:
      'Add your product information so agents and workflows can reference it in replies.',
    cardHint: 'Click to open details',
    moreActions: 'More actions',
    deleteConfirmation:
      'Agents and workflows will no longer be able to reference this product. Continue?',
    loadProductFailed: 'Failed to load product: ',
    deleteFailed: 'Failed to delete product: ',
    basicInfoSection: 'Basic information',
    salesMaterialSection: 'Sales materials',
    productLineLabel: 'Product line',
    productLinePlaceholder: 'For example: Yuanfudao',
    productLineHint: 'Products under the same line are grouped together for digital employee configuration.',
    productLineCount: '{{count}} products',
    keywordsLabel: 'Recognition keywords',
    keywordsPlaceholder: 'English, phonics, reading, thinking, one per line',
    keywordsHint: 'When customers mention these words, the agent prioritizes this product.',
    nameLabel: 'Product name',
    categoryLabel: 'Category',
    priceLabel: 'Price or package',
    linkLabel: 'Product link',
    descriptionLabel: 'Description',
    sellingPointsLabel: 'Selling points',
    painPointsLabel: 'Customer pain points',
    objectionsLabel: 'Common objections',
    audienceLabel: 'Target audience',
    updateTime: 'Updated ',
    today: 'today',
    daysAgo: ' days ago',
    sectionTitle: 'Product Database',
    sectionSubtitle: 'Digital employees reference product data from here',
    enabledLabel: 'Enabled',
    namePlaceholder: 'Product name',
    categoryPlaceholder: 'Category',
    pricePlaceholder: 'Price or package',
    linkPlaceholder: 'Product link',
    descriptionPlaceholder: 'Product description',
    sellingPointsPlaceholder: 'Selling points, one per line',
    painPointsPlaceholder: 'Customer pain points, one per line',
    objectionsPlaceholder: 'Common objections, one per line',
    audiencePlaceholder: 'Target audience, one per line',
    saveChanges: 'Save changes',
    addProduct: 'Add product',
    listTitle: 'Stored products',
    statusEnabled: 'Enabled',
    statusDisabled: 'Disabled',
    sampleBadge: 'Sample',
    noDescription: 'No description',
    emptyList: 'No products yet. Add your product information.',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      uploading: 'Uploading...',
      supportedFormats:
        'Supports PDF, Word, Excel, TXT, Markdown, HTML, ZIP and other document formats',
      uploadSuccess: 'File uploaded successfully!',
      uploadError: 'File upload failed: ',
      uploadingFile: 'Uploading file...',
      fileSizeExceeded:
        'File size exceeds 500MB limit. Please split into smaller files.',
      actions: 'Actions',
      delete: 'Delete File',
      ...
      useBuiltinParserHint:
        'The built-in knowledge engine can ingest Markdown and plain text files directly.',
    ...
    configureEmbeddingHint:
      'Add an embedding model in Model Settings (Embedding Models category).',
    installEngineHint: 'Use the built-in knowledge engine after configuring an embedding model',
  ...
  aiAgents: {
    ...
    configureModelsHint:
      'No configured models available. Add a provider in Model Settings and fill in the API key and base URL.',
  },
};
