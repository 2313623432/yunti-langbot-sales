const enUS = {
  ...
  models: {
    ...
    requesterHint:
      'Choose the calling protocol your API is compatible with. It does not need to match the real model vendor. Gateways usually use OpenAI compatible or Anthropic compatible.',
