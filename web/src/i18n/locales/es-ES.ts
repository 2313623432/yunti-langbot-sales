const esES = {
  ...
  models: {
    ...
    builtin: 'Integrado',
    recommendedProtocols: 'Protocolos recomendados',
    otherProtocolAdapters: 'Más adaptadores de protocolo',
    ...
    requester: 'Protocolo de API',
    selectRequester: 'Seleccionar protocolo de API',
    requesterHint:
      'Elige el protocolo de llamada compatible con tu API. No tiene que coincidir con el proveedor real del modelo. Las pasarelas suelen usar compatible con OpenAI o compatible con Anthropic.',
    ...
    providerName: 'Nombre de conexión',
    providerNamePlaceholder: 'Ej.: pasarela de modelos de la empresa',
    providerNameRequired: 'El nombre de conexión es obligatorio',
    requesterRequired: 'El protocolo de API es obligatorio',
    ...
    providerDeleteBlocked:
      'Elimina todos los modelos de este proveedor antes de eliminarlo',
  ...
  plugins: {
    ...
    fileUpload: {
      tooLarge: 'El tamaño del archivo supera el límite de 500MB',
  ...
  productLibrary: {
    description: 'Gestiona productos y materiales de cursos para empleados digitales',
    pageTitle: 'Biblioteca de productos',
    pageDescription:
      'Mantén nombres, precios, puntos de venta y audiencias objetivo. Los empleados digitales usan estos datos al responder clientes.',
    searchPlaceholder: 'Buscar por nombre, categoría o puntos de venta',
    createProduct: 'Añadir producto',
    createDialogDescription:
      'Completa la información básica y los materiales de venta. Los agentes y flujos de trabajo podrán referenciarlos tras guardar.',
    emptyListTitle: 'No hay productos',
    emptyListDescription:
      'Añade información de productos para que agentes y flujos de trabajo la referencien en las respuestas.',
    cardHint: 'Haz clic para abrir detalles',
    moreActions: 'Más acciones',
    deleteConfirmation:
      'Los agentes y flujos de trabajo ya no podrán referenciar este producto. ¿Continuar?',
    loadProductFailed: 'Error al cargar el producto: ',
    deleteFailed: 'Error al eliminar el producto: ',
    basicInfoSection: 'Información básica',
    salesMaterialSection: 'Materiales de venta',
    nameLabel: 'Nombre del producto',
    categoryLabel: 'Categoría',
    priceLabel: 'Precio o paquete',
    linkLabel: 'Enlace del producto',
    descriptionLabel: 'Descripción',
    sellingPointsLabel: 'Puntos de venta',
    painPointsLabel: 'Problemas del cliente',
    objectionsLabel: 'Objeciones comunes',
    audienceLabel: 'Audiencia objetivo',
    updateTime: 'Actualizado ',
    today: 'hoy',
    daysAgo: ' días',
    sectionTitle: 'Base de datos de productos',
    sectionSubtitle: 'Los empleados digitales referencian los productos desde aquí',
    enabledLabel: 'Activado',
    namePlaceholder: 'Nombre del producto',
    categoryPlaceholder: 'Categoría',
    pricePlaceholder: 'Precio o paquete',
    linkPlaceholder: 'Enlace del producto',
    descriptionPlaceholder: 'Descripción del producto',
    sellingPointsPlaceholder: 'Puntos de venta, uno por línea',
    painPointsPlaceholder: 'Problemas del cliente, uno por línea',
    objectionsPlaceholder: 'Objeciones comunes, una por línea',
    audiencePlaceholder: 'Audiencia objetivo, una por línea',
    saveChanges: 'Guardar cambios',
    addProduct: 'Añadir producto',
    listTitle: 'Productos almacenados',
    statusEnabled: 'Activado',
    statusDisabled: 'Desactivado',
    sampleBadge: 'Ejemplo',
    noDescription: 'Sin descripción',
    emptyList: 'No hay productos. Añade la información de tus productos.',
    nameRequired: 'El nombre del producto es obligatorio',
    createSuccess: 'Producto añadido',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      fileSizeExceeded:
        'El tamaño del archivo supera el límite de 500MB. Por favor, divídelo en archivos más pequeños.',
      actions: 'Acciones',
