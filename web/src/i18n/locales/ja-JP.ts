const jaJP = {
  ...
  models: {
    ...
    builtin: 'ビルトイン',
    recommendedProtocols: '推奨プロトコル',
    otherProtocolAdapters: 'その他のプロトコルアダプター',
    ...
    requester: 'API プロトコル',
    selectRequester: 'API プロトコルを選択',
    requesterHint:
      'API が互換性を持つ呼び出しプロトコルを選択してください。実際のモデルベンダーと一致している必要はありません。ゲートウェイでは通常 OpenAI 互換または Anthropic 互換を選びます。',
    ...
    providerName: '接続名',
    providerNamePlaceholder: '例：社内モデルゲートウェイ',
    providerNameRequired: '接続名は必須です',
    requesterRequired: 'API プロトコルは必須です',
    ...
    providerDeleteBlocked:
      'プロバイダーを削除する前に、配下のすべてのモデルを削除してください',
  ...
  plugins: {
    ...
    fileUpload: {
      tooLarge: 'ファイルサイズが 500MB の制限を超えています',
  ...
  productLibrary: {
    description: '販売製品とコース資料を管理し、デジタル従業員が参照',
    pageTitle: '製品ライブラリ',
    pageDescription:
      '製品名、価格、売りポイント、対象顧客などを管理します。デジタル従業員は顧客対応時にここから参照します。',
    searchPlaceholder: '製品名、カテゴリ、売りポイントで検索',
    createProduct: '製品を追加',
    createDialogDescription:
      '基本情報と販売資料を入力してください。保存後、エージェントとワークフローが参照できます。',
    emptyListTitle: '製品がありません',
    emptyListDescription:
      '販売中の製品情報を追加すると、エージェントとワークフローが返信時に参照します。',
    cardHint: 'クリックして詳細を開く',
    moreActions: 'その他の操作',
    deleteConfirmation:
      '削除すると、エージェントとワークフローはこの製品を参照できなくなります。続行しますか？',
    loadProductFailed: '製品の読み込みに失敗しました：',
    deleteFailed: '製品の削除に失敗しました：',
    basicInfoSection: '基本情報',
    salesMaterialSection: '販売資料',
    nameLabel: '製品名',
    categoryLabel: 'カテゴリ',
    priceLabel: '価格またはプラン',
    linkLabel: '製品リンク',
    descriptionLabel: '製品説明',
    sellingPointsLabel: '売りポイント',
    painPointsLabel: '顧客の課題',
    objectionsLabel: 'よくある異議',
    audienceLabel: '対象顧客',
    updateTime: '更新：',
    today: '今日',
    daysAgo: '日前',
    sectionTitle: '製品データベース',
    sectionSubtitle: 'デジタル従業員はここから製品情報を参照します',
    enabledLabel: '有効',
    namePlaceholder: '製品名',
    categoryPlaceholder: 'カテゴリ',
    pricePlaceholder: '価格またはプラン',
    linkPlaceholder: '製品リンク',
    descriptionPlaceholder: '製品説明',
    sellingPointsPlaceholder: '売りポイント（1行に1つ）',
    painPointsPlaceholder: '顧客の課題（1行に1つ）',
    objectionsPlaceholder: 'よくある異議（1行に1つ）',
    audiencePlaceholder: '対象顧客（1行に1つ）',
    saveChanges: '変更を保存',
    addProduct: '製品を追加',
    listTitle: '登録済み製品',
    statusEnabled: '有効',
    ...
    sampleBadge: 'サンプル',
    noDescription: '説明なし',
    emptyList: '製品がありません。販売中の製品情報を追加してください。',
    nameRequired: '製品名は必須です',
    createSuccess: '製品を追加しました',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      fileSizeExceeded:
        'ファイルサイズが500MBの制限を超えています。より小さいファイルに分割してください。',
      actions: 'アクション',
      delete: 'ドキュメントを削除',
