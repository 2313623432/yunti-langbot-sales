const ruRU = {
  ...
  models: {
    ...
    builtin: 'Встроенный',
    recommendedProtocols: 'Рекомендуемые протоколы',
    otherProtocolAdapters: 'Другие адаптеры протоколов',
    ...
    requester: 'Протокол API',
    selectRequester: 'Выберите протокол API',
    requesterHint:
      'Выберите протокол вызова, с которым совместим ваш API. Он не обязан совпадать с реальным поставщиком модели. Шлюзы обычно используют совместимость с OpenAI или Anthropic.',
    ...
    providerName: 'Имя подключения',
    providerNamePlaceholder: 'Напр.: корпоративный шлюз моделей',
    providerNameRequired: 'Имя подключения обязательно',
    requesterRequired: 'Протокол API обязателен',
