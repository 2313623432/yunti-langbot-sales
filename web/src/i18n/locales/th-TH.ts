const thTH = {
  ...
  models: {
    ...
    builtin: 'ในตัว',
    recommendedProtocols: 'โปรโตคอลที่แนะนำ',
    otherProtocolAdapters: 'อะแดปเตอร์โปรโตคอลเพิ่มเติม',
    openaiCompatible: 'เข้ากันได้กับ OpenAI',
    anthropicCompatible: 'เข้ากันได้กับ Anthropic',
    ...
    requester: 'โปรโตคอล API',
    selectRequester: 'เลือกโปรโตคอล API',
    requesterHint:
      'เลือกโปรโตคอลการเรียกที่ API ของคุณรองรับ ไม่จำเป็นต้องตรงกับผู้ผลิตโมเดลจริง เกตเวย์มักใช้แบบเข้ากันได้กับ OpenAI หรือ Anthropic',
    ...
    providerName: 'ชื่อการเชื่อมต่อ',
    providerNamePlaceholder: 'เช่น เกตเวย์โมเดลของบริษัท',
    providerNameRequired: 'กรุณากรอกชื่อการเชื่อมต่อ',
    requesterRequired: 'กรุณาเลือกโปรโตคอล API',
    ...
    providerDeleteBlocked:
      'โปรดลบโมเดลทั้งหมดภายใต้ผู้ให้บริการนี้ก่อนลบผู้ให้บริการ',
  ...
  plugins: {
    ...
    fileUpload: {
      tooLarge: 'ขนาดไฟล์เกินขีดจำกัด 500MB',
  ...
  productLibrary: {
    description: 'จัดการผลิตภัณฑ์และเอกสารคอร์สสำหรับพนักงานดิจิทัล',
    pageTitle: 'คลังผลิตภัณฑ์',
    pageDescription:
      'จัดการชื่อ ราคา จุดขาย และกลุ่มเป้าหมาย พนักงานดิจิทัลจะอ้างอิงข้อมูลจากที่นี่เมื่อตอบลูกค้า',
    searchPlaceholder: 'ค้นหาตามชื่อ หมวดหมู่ หรือจุดขาย',
    createProduct: 'เพิ่มผลิตภัณฑ์',
    createDialogDescription:
      'กรอกข้อมูลพื้นฐานและเอกสารการขาย หลังบันทึกแล้ว Agent และ Workflow สามารถอ้างอิงได้',
    emptyListTitle: 'ยังไม่มีผลิตภัณฑ์',
    emptyListDescription:
      'เพิ่มข้อมูลผลิตภัณฑ์เพื่อให้ Agent และ Workflow อ้างอิงเมื่อตอบลูกค้า',
    cardHint: 'คลิกเพื่อเปิดรายละเอียด',
    moreActions: 'การดำเนินการเพิ่มเติม',
    deleteConfirmation:
      'Agent และ Workflow จะไม่สามารถอ้างอิงผลิตภัณฑ์นี้ได้อีก ดำเนินการต่อหรือไม่?',
    loadProductFailed: 'โหลดผลิตภัณฑ์ไม่สำเร็จ: ',
    deleteFailed: 'ลบผลิตภัณฑ์ไม่สำเร็จ: ',
    basicInfoSection: 'ข้อมูลพื้นฐาน',
    salesMaterialSection: 'เอกสารการขาย',
    nameLabel: 'ชื่อผลิตภัณฑ์',
    categoryLabel: 'หมวดหมู่',
    priceLabel: 'ราคาหรือแพ็กเกจ',
    linkLabel: 'ลิงก์ผลิตภัณฑ์',
    descriptionLabel: 'คำอธิบาย',
    sellingPointsLabel: 'จุดขาย',
    painPointsLabel: 'ปัญหาของลูกค้า',
    objectionsLabel: 'ข้อโต้แย้งทั่วไป',
    audienceLabel: 'กลุ่มเป้าหมาย',
    updateTime: 'อัปเดต ',
    today: 'วันนี้',
    daysAgo: ' วันที่แล้ว',
    sectionTitle: 'ฐานข้อมูลผลิตภัณฑ์',
    sectionSubtitle: 'พนักงานดิจิทัลอ้างอิงข้อมูลผลิตภัณฑ์จากที่นี่',
    enabledLabel: 'เปิดใช้งาน',
    namePlaceholder: 'ชื่อผลิตภัณฑ์',
    categoryPlaceholder: 'หมวดหมู่',
    pricePlaceholder: 'ราคาหรือแพ็กเกจ',
    linkPlaceholder: 'ลิงก์ผลิตภัณฑ์',
    descriptionPlaceholder: 'คำอธิบายผลิตภัณฑ์',
    sellingPointsPlaceholder: 'จุดขาย หนึ่งบรรทัดต่อหนึ่งรายการ',
    painPointsPlaceholder: 'ปัญหาของลูกค้า หนึ่งบรรทัดต่อหนึ่งรายการ',
    objectionsPlaceholder: 'ข้อโต้แย้งทั่วไป หนึ่งบรรทัดต่อหนึ่งรายการ',
    audiencePlaceholder: 'กลุ่มเป้าหมาย หนึ่งบรรทัดต่อหนึ่งรายการ',
    saveChanges: 'บันทึกการเปลี่ยนแปลง',
    addProduct: 'เพิ่มผลิตภัณฑ์',
    listTitle: 'ผลิตภัณฑ์ที่บันทึกแล้ว',
    statusEnabled: 'เปิดใช้งาน',
    statusDisabled: 'ปิดใช้งาน',
    sampleBadge: 'ตัวอย่าง',
    noDescription: 'ไม่มีคำอธิบาย',
    emptyList: 'ยังไม่มีผลิตภัณฑ์ กรุณาเพิ่มข้อมูลผลิตภัณฑ์ของคุณ',
    nameRequired: 'ต้องระบุชื่อผลิตภัณฑ์',
    createSuccess: 'เพิ่มผลิตภัณฑ์แล้ว',
    updateSuccess: 'อัปเดตผลิตภัณฑ์แล้ว',
    deleteSuccess: 'ลบผลิตภัณฑ์แล้ว',
  },
  knowledge: {
    title: 'ฐานความรู้',
    ...
    documentsTab: {
      ...
      fileSizeExceeded: 'ขนาดไฟล์เกินขีดจำกัด 500MB กรุณาแบ่งเป็นไฟล์ขนาดเล็กลง',
      actions: 'การดำเนินการ',
      delete: 'ลบไฟล์',
