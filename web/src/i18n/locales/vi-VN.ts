const viVN = {
  ...
  models: {
    ...
    recommendedProtocols: 'Giao thức đề xuất',
    otherProtocolAdapters: 'Bộ chuyển đổi giao thức khác',
    openaiCompatible: 'Tương thích OpenAI',
    anthropicCompatible: 'Tương thích Anthropic',
    ...
    requester: 'Giao thức API',
    selectRequester: 'Chọn giao thức API',
    requesterHint:
      'Chọn giao thức gọi API tương thích với dịch vụ của bạn. Không cần trùng với nhà cung cấp mô hình thực tế. Gateway thường dùng tương thích OpenAI hoặc tương thích Anthropic.',
    ...
    providerName: 'Tên kết nối',
    providerNamePlaceholder: 'VD: Gateway mô hình công ty',
    providerNameRequired: 'Tên kết nối là bắt buộc',
    requesterRequired: 'Giao thức API là bắt buộc',
    ...
    providerDeleteBlocked:
      'Hãy xóa tất cả mô hình của nhà cung cấp này trước khi xóa nhà cung cấp',
  ...
  plugins: {
    ...
    fileUpload: {
      tooLarge: 'Kích thước tệp vượt quá giới hạn 500MB',
  ...
  productLibrary: {
    description: 'Quản lý sản phẩm và tài liệu khóa học cho nhân viên số',
    pageTitle: 'Thư viện sản phẩm',
    pageDescription:
      'Quản lý tên, giá, điểm bán hàng và đối tượng khách hàng. Nhân viên số tham chiếu dữ liệu này khi trả lời khách hàng.',
    searchPlaceholder: 'Tìm theo tên, danh mục hoặc điểm bán hàng',
    createProduct: 'Thêm sản phẩm',
    createDialogDescription:
      'Điền thông tin cơ bản và tài liệu bán hàng. Agent và workflow có thể tham chiếu sau khi lưu.',
    emptyListTitle: 'Chưa có sản phẩm',
    emptyListDescription:
      'Thêm thông tin sản phẩm để agent và workflow tham chiếu khi trả lời khách hàng.',
    cardHint: 'Nhấp để mở chi tiết',
    moreActions: 'Thao tác khác',
    deleteConfirmation:
      'Agent và workflow sẽ không thể tham chiếu sản phẩm này nữa. Tiếp tục?',
    loadProductFailed: 'Không thể tải sản phẩm: ',
    deleteFailed: 'Không thể xóa sản phẩm: ',
    basicInfoSection: 'Thông tin cơ bản',
    salesMaterialSection: 'Tài liệu bán hàng',
    nameLabel: 'Tên sản phẩm',
    categoryLabel: 'Danh mục',
    priceLabel: 'Giá hoặc gói',
    linkLabel: 'Liên kết sản phẩm',
    descriptionLabel: 'Mô tả',
    sellingPointsLabel: 'Điểm bán hàng',
    painPointsLabel: 'Vấn đề của khách hàng',
    objectionsLabel: 'Phản đối thường gặp',
    audienceLabel: 'Đối tượng khách hàng',
    updateTime: 'Cập nhật ',
    today: 'hôm nay',
    daysAgo: ' ngày trước',
    sectionTitle: 'Cơ sở dữ liệu sản phẩm',
    sectionSubtitle: 'Nhân viên số tham chiếu sản phẩm từ đây',
    enabledLabel: 'Bật',
    namePlaceholder: 'Tên sản phẩm',
    categoryPlaceholder: 'Danh mục',
    pricePlaceholder: 'Giá hoặc gói',
    linkPlaceholder: 'Liên kết sản phẩm',
    descriptionPlaceholder: 'Mô tả sản phẩm',
    sellingPointsPlaceholder: 'Điểm bán hàng, mỗi dòng một mục',
    painPointsPlaceholder: 'Vấn đề của khách hàng, mỗi dòng một mục',
    objectionsPlaceholder: 'Phản đối thường gặp, mỗi dòng một mục',
    audiencePlaceholder: 'Đối tượng khách hàng, mỗi dòng một mục',
    saveChanges: 'Lưu thay đổi',
    addProduct: 'Thêm sản phẩm',
    listTitle: 'Sản phẩm đã lưu',
    statusEnabled: 'Đã bật',
    statusDisabled: 'Đã tắt',
    sampleBadge: 'Mẫu',
    noDescription: 'Không có mô tả',
    emptyList: 'Chưa có sản phẩm. Hãy thêm thông tin sản phẩm của bạn.',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      fileSizeExceeded:
        'Kích thước tệp vượt quá giới hạn 500MB. Vui lòng chia thành các tệp nhỏ hơn.',
      actions: 'Hành động',
      delete: 'Xóa tệp',
