const zhHans = {
  ...
  bots: {
    title: '发布渠道',
    description: '接入和管理通讯软件平台，把客户消息发布到指定 Workflow 或 AI Agent',
    createBot: '创建发布渠道',
    ...
    bindPipeline: '绑定 Workflow',
    selectPipeline: '选择 Workflow',
    selectBot: '请选择发布渠道',
    botLogTitle: '发布渠道日志',
    ...
    routingConnectionDescription: '选择此通讯平台接入后由哪个 Workflow 或 AI Agent 处理消息',
    routingRules: '条件路由规则',
    routingRulesDescription:
      '按顺序匹配，命中第一条规则后路由到对应 Workflow；都不匹配时使用上方默认 Workflow',
    addRoutingRule: '添加规则',
