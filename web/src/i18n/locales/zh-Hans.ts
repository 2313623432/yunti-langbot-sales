const zhHans = {
  ...
  models: {
    ...
    streamingAbility: '流式输出',
    apiKeyNotConfigured: '未配置',
    providerDeleteBuiltinBlocked: '内置供应商不能删除',
    builtinProvider: '内置',
    modelProvider: '模型提供商',
    modelBaseURL: '基础 URL',
    modelAbilities: '模型能力',
    ...
    selfDeployed: '自部署',
    builtin: '内置',
    recommendedProtocols: '推荐协议',
    otherProtocolAdapters: '更多接口适配器',
    ...
    requester: '接口协议',
    apiMode: 'API 模式',
    selectRequester: '选择接口协议',
    requesterHint:
      '选择 API 兼容的调用协议，不要求与真实模型厂商一致。国内模型除 MiniMax 外通常选择 OpenAI 协议，MiniMax 选择 Claude 协议。',
    protocol: {
      openai: 'OpenAI 协议',
      claude: 'Claude 协议',
      gemini: 'Gemini 协议',
    ...
    providerName: '接入名称',
    providerNamePlaceholder: '例如：公司模型中转站',
    providerNameRequired: '接入名称不能为空',
    requesterRequired: '接口协议不能为空',
    providerSaved: '供应商已保存',
    providerCreated: '供应商已创建',
    providerSaveError: '保存供应商失败：',
    providerDeleted: '供应商已删除',
    providerDeleteError: '删除供应商失败：',
    providerDeleteBlocked: '请先删除该供应商下的所有模型，再删除供应商',
    deleteProviderConfirmation: '你确定要删除这个供应商吗？',
    loadError: '加载数据失败',
    chat: '对话',
    embedding: '嵌入',
    textCategory: '文本模型',
    embeddingCategory: 'Embedding 模型',
    voiceCategory: '语音合成',
    asrCategory: '语音识别',
    pdfCategory: 'PDF 解析',
    textConfigTitle: '文本模型配置',
    embeddingConfigTitle: 'Embedding 模型配置',
    voiceConfigTitle: '语音合成配置',
    asrConfigTitle: '语音识别配置',
    pdfConfigTitle: 'PDF 解析配置',
    textListTitle: '文本模型',
    embeddingListTitle: 'Embedding 模型',
    voiceListTitle: '语音模型',
    asrListTitle: '语音识别模型',
    pdfListTitle: 'PDF 解析模型',
    textListHint: '只展示可用于对话和视觉理解的文本模型。',
    embeddingListHint:
      '用于知识库向量化检索。请在扩展参数中配置 model 字段，例如 text-embedding-v3。',
    voiceListHint: '只展示已勾选语音合成能力的模型。',
    asrListHint: '只展示已勾选语音识别能力的模型。',
    pdfListHint: '只展示已勾选 PDF 解析能力的模型。',
    noEmbeddingModels: '暂无 Embedding 模型，请点击新建模型。',
    noVoiceModels: '暂无语音模型，请新增模型并勾选语音合成。',
    noAsrModels: '暂无语音识别模型，请新增模型并勾选语音识别。',
    noPdfModels: '暂无 PDF 解析模型，请新增模型并勾选 PDF 解析。',
    asrAbility: '语音识别',
    asrTestTitle: '测试 ASR',
    asrTestPlaceholder: '录音后将显示识别结果',
    asrTestStart: '开始录音',
    asrTestStop: '停止录音',
    asrRecordRequired: '请先录音后再测试',
    asrMicUnavailable: '无法访问麦克风，请检查浏览器权限',
    asrRecordError: '录音处理失败，请重试',
    pdfParseAbility: 'PDF 解析',
    rerank: '重排序',
    rerankUrlTooltip:
  ...
  bots: {
    title: '发布渠道',
    description: '接入和管理通讯软件平台，把客户消息发布到指定数字员工',
    createBot: '创建发布渠道',
    selectFromSidebar: '从侧边栏选择一个发布渠道',
    editBot: '编辑发布渠道',
    getBotListError: '获取机器人列表失败：',
    botName: '渠道名称',
    botDescription: '渠道描述',
    botNameRequired: '渠道名称不能为空',
    botDescriptionRequired: '渠道描述不能为空',
    adapterRequired: '适配器不能为空',
    defaultDescription: '一个发布渠道',
    getBotConfigError: '获取发布渠道配置失败：',
    saveSuccess: '保存成功',
    saveError: '保存失败：',
    createSuccess: '创建成功，请启用并绑定处理对象',
    createError: '创建失败：',
    deleteSuccess: '删除成功',
    deleteError: '删除失败：',
    deleteConfirmation: '你确定要删除这个发布渠道吗？',
    platformAdapter: '通讯平台/适配器选择',
    selectAdapter: '选择适配器',
    adapterConfig: '平台发布配置',
    viewAdapterDocs: '查看文档',
    bindPipeline: '绑定数字员工',
    selectPipeline: '选择数字员工',
    selectBot: '请选择发布渠道',
    botLogTitle: '发布渠道日志',
    ...
    setBotEnableError: '设置发布渠道启用状态失败',
    log: '日志',
    configuration: '配置',
    logs: '日志',
    basicInfo: '基础信息',
    basicInfoDescription: '设置发布渠道名称和描述',
    routingConnection: '消息处理绑定',
    routingConnectionDescription: '选择此通讯平台接入后由哪个数字员工处理消息',
    routingRules: '条件路由规则',
    routingRulesDescription:
      '按顺序匹配，命中第一条规则后路由到对应数字员工；都不匹配时使用上方默认数字员工',
    addRoutingRule: '添加规则',
    ...
    sessionTypeGroup: '群聊',
    adapterConfigDescription: '配置所选通讯平台的发布参数和回调地址',
    dangerZone: '危险区域',
    dangerZoneDescription: '不可逆的操作',
    deleteBotAction: '删除此发布渠道',
  ...
  plugins: {
    title: '插件扩展',
    description: '安装和配置用于扩展功能的插件，请在数字员工配置中选用',
    createPlugin: '创建插件',
    editPlugin: '编辑插件',
    installed: '已安装',
    marketplace: '插件市场',
  ...
  pipelines: {
    title: '数字员工',
    description: '数字员工定义了客户消息的处理方式，可绑定到发布渠道',
    createPipeline: '创建数字员工',
    selectFromSidebar: '从侧边栏选择一个数字员工',
    editPipeline: '编辑数字员工',
    chat: '对话',
    configuration: '配置',
    debugChat: '对话调试',
    getPipelineListError: '获取数字员工列表失败：',
    daysAgo: '天前',
    today: '今天',
    updateTime: '更新于',
    defaultBadge: '默认',
    ...
    earliestEdited: '最早编辑',
    basicInfo: '基础信息',
    basicInfoDescription: '设置数字员工名称、图标和描述',
    ...
    createSuccess: '创建成功 请编辑数字员工详细参数',
    createError: '创建失败：',
    saveSuccess: '保存成功',
    saveError: '保存失败：',
    copySuffix: ' Copy',
    deleteConfirmation:
      '你确定要删除这个数字员工吗？已绑定此数字员工的渠道将无法使用。',
    defaultPipelineCannotDelete: '默认数字员工不可删除',
    deleteSuccess: '删除成功',
    deleteError: '删除失败：',
    copyConfirmTitle: '确认复制',
    copyConfirmation:
      '确定要复制这个数字员工吗？复制将创建一个包含完整配置的新数字员工。',
    unsavedChanges: '有未保存的更改',
    dangerZone: '危险区域',
    dangerZoneDescription: '不可逆的操作',
    deletePipelineAction: '删除此数字员工',
    deletePipelineHint: '删除后，绑定此数字员工的渠道将无法正常工作。',
    copyPipelineAction: '复制此数字员工',
    copyPipelineHint: '创建一个新的数字员工，并复制所有配置。',
    templateConfig: {
      asrModelSectionTitle: '语音识别模型',
      asrModelSectionDescription: '配置用户发语音时使用的语音识别模型。',
      asrModelLabel: '语音识别模型',
      asrModelPlaceholder: '请选择语音识别模型',
      asrModelEmptyHint: '请先在模型配置中添加语音识别模型',
      asrFallbackLabel: '识别失败兜底文案',
      asrFallbackPlaceholder: '用户发来一条语音咨询，请用短句回复。',
    },
    extensions: {
      title: '扩展集成',
      loadError: '加载插件列表失败',
    ...
    monitoring: {
      title: '监控日志',
      description: '查看此数字员工的运行记录和错误信息（最近24小时）',
      detailedLogs: '详细日志',
    },
  },
  productLibrary: {
    description: '管理在售产品与课程资料，供数字员工引用',
    pageTitle: '产品库',
    pageDescription:
      '按产品线维护在售产品资料。一条产品线（如猿辅导）下可包含多个具体产品，数字员工会按产品线与产品两层结构引用。',
    searchPlaceholder: '搜索产品名称、分类或卖点',
    createProduct: '添加产品',
    createDialogDescription:
      '填写产品基础信息与销售资料，保存后数字员工和工作流即可引用。',
    emptyListTitle: '暂无产品',
    emptyListDescription: '添加在售产品资料后，数字员工回复和推荐课程时会自动引用。',
    cardHint: '点击进入详情',
    moreActions: '更多操作',
    deleteConfirmation: '删除后，工作流和数字员工将无法再引用该产品资料，确定删除吗？',
    loadProductFailed: '加载产品失败：',
    deleteFailed: '删除产品失败：',
    basicInfoSection: '基础信息',
    salesMaterialSection: '销售资料',
    productLineLabel: '所属产品线',
    productLinePlaceholder: '例如：猿辅导',
    productLineHint: '同一产品线下的多个产品会归为一组，供数字员工按业务线统一配置。',
    productLineCount: '{{count}} 个产品',
    keywordsLabel: '识别关键词',
    keywordsPlaceholder: '英语、自然拼读、阅读、思维，一行一个',
    keywordsHint: '客户提到这些词时，数字员工会优先匹配到该产品。',
    nameLabel: '产品名称',
    categoryLabel: '分类',
    priceLabel: '价格或套餐',
    linkLabel: '产品链接',
    ...
    painPointsLabel: '客户痛点',
    objectionsLabel: '常见异议',
    audienceLabel: '适用客户',
    updateTime: '更新于',
    today: '今天',
    daysAgo: '天前',
    sectionTitle: '产品数据库',
    sectionSubtitle: '数字员工回复客户时会引用这里的产品资料',
    enabledLabel: '启用',
    namePlaceholder: '产品名称',
    categoryPlaceholder: '分类',
    pricePlaceholder: '价格或套餐',
    linkPlaceholder: '产品链接',
    descriptionPlaceholder: '产品描述',
    sellingPointsPlaceholder: '卖点，一行一个',
    painPointsPlaceholder: '客户痛点，一行一个',
    objectionsPlaceholder: '常见异议，一行一个',
    audiencePlaceholder: '适用客户，一行一个',
    saveChanges: '保存修改',
    addProduct: '入库',
    listTitle: '已入库产品',
    statusEnabled: '启用',
  ...
  knowledge: {
    ...
    createDialogDescription: '填写名称和描述即可创建，创建后上传文档供数字员工引用。',
    searchPlaceholder: '搜索知识库名称或描述',
    emptyListTitle: '暂无知识库',
    emptyListDescription: '创建知识库后，可在此上传和管理文档资料。',
    cardHint: '点击进入详情',
    fileCountLabel: '{{count}} 个文档',
    ...
    empty: '无',
    editDocument: '文档',
    description: '上传销售话术、FAQ 和产品资料，供数字员工和工作流引用',
    metadata: '元数据',
    documents: '文档',
    ...
    documentsTab: {
      ...
      statusCompleted: '学习完成',
      statusPending: '未启动',
      statusFailed: '学习失败',
      uploadedAt: '上传时间',
      uploadFile: '上传文件',
      uploadDialogTitle: '上传文档',
      uploadDialogDescription: '支持拖拽或点击选择文件，上传后将自动解析入库。',
      searchPlaceholder: '搜索文件名',
      noResults: '暂无文档',
      dragAndDrop: '拖拽文件到此处或点击上传',
      uploading: '上传中...',
      supportedFormats: '支持 PDF、Word、Excel、TXT、Markdown、HTML、ZIP 等文档格式',
      uploadSuccess: '文件上传成功！',
      uploadError: '文件上传失败：',
      uploadingFile: '上传文件中...',
      fileSizeExceeded: '文件大小超过 500MB 限制，请分割成较小的文件后上传',
      actions: '操作',
      delete: '删除文件',
      ...
      useBuiltinParserHint: '内置知识库引擎可直接处理 Markdown / 纯文本文件。',
      confirmUpload: '上传',
      cancelUpload: '取消',
    },
    ...
    basicInfo: '基础信息',
    basicInfoDescription: '设置知识库名称和描述',
    basicInfoEditDescription: '修改知识库名称和描述',
    editKbInfo: '编辑知识库',
    editKbInfoDescription: '修改知识库名称和描述',
    moreActions: '更多',
    deleteKnowledgeBaseSuccess: '知识库已删除',
    settingsTab: '设置',
    engineSettings: '引擎设置',
    ...
    configureEmbeddingHint: '请先在模型配置中添加 Embedding 模型（左侧 Embedding 模型栏目）。',
    installEngineHint: '内置知识库引擎已可用，请配置 Embedding 模型',
  ...
  limitation: {
    ...
    maxPipelinesReached:
      '已达到数字员工数量上限（{{max}}个）。请先删除已有数字员工后再创建新的。',
  ...
  aiAgents: {
    ...
    configureModelsHint:
      '暂无已配置的模型。请先在模型配置中添加供应商，并填写 API Key 与 Base URL。',
  },
};
