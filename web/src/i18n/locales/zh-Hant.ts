const zhHant = {
  ...
  models: {
    ...
    selfDeployed: '自部署',
    builtin: '內建',
    recommendedProtocols: '推薦協議',
    otherProtocolAdapters: '更多介面適配器',
    openaiCompatible: 'OpenAI 相容',
    anthropicCompatible: 'Anthropic 相容',
    selectModel: '請選擇模型',
    testSuccess: '測試成功',
    ...
    requester: '介面協議',
    selectRequester: '選擇介面協議',
    requesterHint:
      '選擇 API 相容的呼叫協議，不要求與真實模型廠商一致。中轉站通常選擇 OpenAI 相容或 Anthropic 相容。',
    ...
    noProviders: '暫無供應商',
    providerName: '接入名稱',
    providerNamePlaceholder: '例如：公司模型中轉站',
    providerNameRequired: '接入名稱不能為空',
    requesterRequired: '介面協議不能為空',
    providerSaved: '供應商已儲存',
    providerCreated: '供應商已建立',
    providerSaveError: '儲存供應商失敗：',
    providerDeleted: '供應商已刪除',
    providerDeleteError: '刪除供應商失敗：',
    providerDeleteBlocked: '請先刪除該供應商下的所有模型，再刪除供應商',
  ...
  productLibrary: {
    description: '管理在售產品與課程資料，供數位員工引用',
    pageTitle: '產品庫',
    pageDescription:
      '維護產品名稱、價格、賣點與適用客戶等資訊。數位員工在回覆客戶和推薦課程時會引用此處的產品資料。',
    searchPlaceholder: '搜尋產品名稱、分類或賣點',
    createProduct: '新增產品',
    createDialogDescription:
      '填寫產品基礎資訊與銷售資料，儲存後數位員工和工作流即可引用。',
    emptyListTitle: '暫無產品',
    emptyListDescription: '新增在售產品資料後，數位員工回覆和推薦課程時會自動引用。',
    cardHint: '點擊進入詳情',
    moreActions: '更多操作',
    deleteConfirmation: '刪除後，工作流和數位員工將無法再引用該產品資料，確定刪除嗎？',
    loadProductFailed: '載入產品失敗：',
    deleteFailed: '刪除產品失敗：',
    basicInfoSection: '基礎資訊',
    salesMaterialSection: '銷售資料',
    nameLabel: '產品名稱',
    categoryLabel: '分類',
    priceLabel: '價格或套餐',
    linkLabel: '產品連結',
    descriptionLabel: '產品描述',
    sellingPointsLabel: '賣點',
    painPointsLabel: '客戶痛點',
    objectionsLabel: '常見異議',
    audienceLabel: '適用客戶',
    updateTime: '更新於',
    today: '今天',
    daysAgo: '天前',
    sectionTitle: '產品資料庫',
    sectionSubtitle: '數位員工回覆客戶時會引用這裡的產品資料',
    enabledLabel: '啟用',
    namePlaceholder: '產品名稱',
    categoryPlaceholder: '分類',
    pricePlaceholder: '價格或套餐',
    linkPlaceholder: '產品連結',
    descriptionPlaceholder: '產品描述',
    sellingPointsPlaceholder: '賣點，一行一個',
    painPointsPlaceholder: '客戶痛點，一行一個',
    objectionsPlaceholder: '常見異議，一行一個',
    audiencePlaceholder: '適用客戶，一行一個',
    saveChanges: '儲存修改',
    addProduct: '入庫',
    listTitle: '已入庫產品',
    statusEnabled: '啟用',
    ...
    sampleBadge: '範例',
    noDescription: '暫無描述',
    emptyList: '暫無產品，請先錄入你在售的產品資料',
    nameRequired: '產品名稱不能為空',
    createSuccess: '產品已入庫',
    updateSuccess: '產品已更新',
    deleteSuccess: '產品已刪除',
  },
  knowledge: {
    ...
    documentsTab: {
      ...
      uploadError: '文檔上傳失敗：',
      uploadingFile: '上傳文檔中...',
      fileSizeExceeded: '檔案大小超過 500MB 限制，請分割成較小的檔案後上傳',
      actions: '操作',
      delete: '刪除文檔',
